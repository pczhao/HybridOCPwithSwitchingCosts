function [out] = HybridOCPDualSolver_switching_IC(t,x,u,f,g,hX,hU,sX,R,hX0,hXT,h,H,c,d,options)
% Hybrid optimal control problem - dual solver, with switching cost, optimize over IC.
% ------------------------------------------------------------------------
